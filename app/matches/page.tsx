  ...
  return (
    <div>
      <button
        ...
        className="fixed overflow-hidden bg-dots text-white p-2 rounded-lg translate-x-[80vw] translate-y-[10vh]"
      >
        Log Out
      </button>
      <div className="flex flex-col items-center justify-center mt-12">
        <h1 className="text-3xl font-bold mb-[40px] text-tap-blue">
          Matches by Collaboration Score
        </h1>
          ...
          >
            <div className="group flex justify-between items-center bg-orange-100 p-4 rounded-lg shadow">
              ...
              <div className="flex items-center">
                <svg
                  className="mr-2 w-10 h-10 text-green-500"
                  viewBox="0 0 36 36"
                >
                  <path
                    className="circle-bg"
